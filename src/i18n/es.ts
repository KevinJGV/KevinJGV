...
export default {
  ...
  tools: { muteAria: "Silenciar/Activar música", localeToggleAria: "Cambiar idioma", perfToggleAria: "Alternar modo de bajo rendimiento", noiseToggleAria: "Activar/Desactivar ruido en movimiento", menuAria: "Abrir/cerrar menú de herramientas" },
  sidebar: {
